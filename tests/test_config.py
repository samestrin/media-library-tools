...
TEST_DATA = {
    ...
    "sample_subtitles": ["english.srt", "spanish.vtt", "french.ass", "german.ssa"],
    "sample_images": ["poster.jpg", "fanart.png", "banner.jpeg", "thumb.gif"],
}
...
REPORTING_CONFIG = {
    ...
    "log_levels": {"console": "INFO", "file": "DEBUG", "performance": "WARNING"},
}
