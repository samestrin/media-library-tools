...
class TestFileTypeValidation(MediaLibraryTestCase):
    ...
    def setUp(self):
        ...
        self.batch_season_organizer = (
            BatchSeasonOrganizer() if BatchSeasonOrganizer else None
        )
        self.extras_organizer = (
            PlexMovieExtrasOrganizer() if PlexMovieExtrasOrganizer else None
        )
    ...
    def test_sabnzbd_detector_directory_analysis(self):
        ...
        is_sabnzbd, score, indicators = self.sabnzbd_detector.analyze_directory(
            test_dir
        )
        ...
        self.assertFalse(
            is_sabnzbd,
            "Directory with only video files should not be detected as SABnzbd",
        )
    ...
    def test_plex_renamer_video_extensions(self):
        ...
        for video_file in video_files:
            self.assertTrue(
                self.plex_renamer.is_video_file(video_file),
    ...
    def test_plex_creator_file_types(self):
        ...
        for video_file in video_files:
            ...
            self.assertTrue(
                self.plex_creator.should_process_file(file_path),
    ...
    def test_season_organizer_video_extensions(self):
        ...
        for video_file in video_files:
            self.assertTrue(
                self.season_organizer.is_video_file(test_dir / video_file),
    ...
    def test_batch_season_organizer_video_extensions(self):
        ...
        for video_file in video_files:
            self.assertTrue(
                self.batch_season_organizer.is_video_file(test_dir / video_file),
    ...
    def test_extras_organizer_video_extensions(self):
        ...
        for video_file in video_files:
            self.assertTrue(
                self.extras_organizer.is_video_file(video_file.name),
