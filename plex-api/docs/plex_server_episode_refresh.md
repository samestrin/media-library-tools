...
- **Multiple token sources**: CLI argument, environment variables, or `.env` file
...
3. `.env` file: `echo "PLEX_TOKEN=YOUR_PLEX_TOKEN" > .env`
...
3. `.env` file: `echo "PLEX_SERVER=http://plex.local:32400" >> .env`
4. Default fallback: `http://localhost:32400`
